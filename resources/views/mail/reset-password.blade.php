...
<head>
    ...
    <link href='{{ asset('css/admin/css/mail.css') }}' rel='stylesheet' type='text/css'>
    <!--<![endif]-->
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnTextContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
                                            ...
                                            <tr>
                                                <td class="mcnTextContent" style='mso-line-height-rule: exactly;
                                                        ...
                                                        <img align="none"  src="https://i.pinimg.com/736x/39/f8/30/39f83008cb63c447afc04b8d3816c023--simple-business-ideas-design-development.jpg" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
                                                               text-decoration: none; height: auto; width: auto; height: auto; margin: 0px;" width="107" />
{{--                                                        <img align="none" height="32" src="{{ asset('images/admin/logo_napro.svg') }}" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;--}}
{{--                                                               text-decoration: none; height: auto; width: 107px; height: 32px; margin: 0px;" width="107" />--}}
                    ...
                    <tr>
                        <td id="templateHeader" style="mso-line-height-rule: exactly;
                                    ...
                                    border-top: 0; border-bottom: 0; padding-bottom: 0" valign="top">
                                        ...
                                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
                                            ...
                                            <tr>
                                                <td class="mcnImageContent" style="mso-line-height-rule: exactly;
                                                            ...
                                                            <img align="center" alt="Forgot your password?" class="mcnImage" src="https://www.sayidaty.net/sites/default/files/styles/1375_scale/public/2017/12/28/3185041-1655254827.jpg?itok=rpxTa58p" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;
...
{{--                                                            <img align="center" alt="Forgot your password?" class="mcnImage" src=" {{ asset('images/admin/password.jpg') }}" style="-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;--}}
{{--                                                               text-decoration: none; vertical-align: bottom; max-width:1200px; padding-bottom:--}}
{{--                                                               0; display: inline !important; vertical-align: bottom;" width="600"></img>--}}
                                                </td>
                                            </tr>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="mcnButtonContentContainer" style="border-collapse: collapse; mso-table-lspace: 0;
                                                        ...
                                                        <tr>
                                                            <td align="center" class="mcnButtonContent" style="mso-line-height-rule:
                                                                ...
                                                                <a class="mcnButton " href="{{ env('FRONT_URL'). '/reset-password?email='. $data['params']['email'].'&email_token='.$data['params']['email_token']  }}" style="mso-line-height-rule: exactly;
